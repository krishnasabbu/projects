...
$(document).on('click', '#activeCard', function() {
     ...
     console.log("Fired");
     fireStaticCall('Thanks for choosing Gold Credit Card. Please upload id proof to process further..');
});
...
$(document).on('click', '#biltCard', function() {
     ...
     event.preventDefault();
     console.log("Fired");
     fireStaticCall('Thanks for choosing Silver Credit Card. Please upload id proof to process further..');
});
...
$(document).on('click', '#autographCard', function() {
     ...
     event.preventDefault();
     console.log("Fired");
     fireStaticCall('Thanks for choosing Platinum Credit Card. Please upload id proof to process further..');
});
...
$(document).on('click', '#reflectCard', function() {
     ...
     event.preventDefault();
     console.log("Fired");
     fireStaticCall('Thanks for choosing Visa Credit Card. Please upload id proof to process further..');
});
...
$(document).on('click', '#masterCard', function() {
     ...
     event.preventDefault();
     console.log("Fired");
     fireStaticCall('Thanks for choosing Master Credit Card. Please upload id proof to process further..');
});
...
$(document).on('click', '#selectMasterCard', function() {
     ...
     event.preventDefault();
     console.log("Fired");
     fireStaticCall('Thanks for choosing Select Master Credit Card. Please upload id proof to process further..');
});
...
function initialChat() {
    var askedQ = $("#root").contents().find("#most-asked-questions");
    console.log("askedQ === "+askedQ);
    globalId = 130;
    ...
    var text = '<div class="courses-container"> <div class="course"> <div class="course-preview"> <h4>Gold Credit Card </h4> </div> <div class="course-info"> <h6>$200 cash rewards bonus </h6> <h6>Unlimited 2% cash rewards </h6> <h6>0% intro APR for 15 months </h6> <h6>$0 annual fee </h6> </div> <button id="activeCard" class="cutomBtn">Apply </button> </div></div><div class="courses-container"> <div class="course"> <div class="course-preview"> <h4>Silver Credit Card </h4> </div> <div class="course-info"> <h6>Points on rent </h6> <h6>0 annual fee </h6> <h6>1X-6X points on various categories </h6> <h6>Double points on first of each month </h6> </div> <button id="biltCard" class="cutomBtn">Apply </button> </div></div><div class="courses-container"> <div class="course"> <div class="course-preview"> <h4>Platinum Credit Card </h4> </div> <div class="course-info"> <h6>20,000 bonus points </h6> <h6>0% intro APR for 12 months </h6> <h6>3X points on various categories </h6> <h6>$0 annual fee </h6> </div> <button id="autographCard" class="cutomBtn">Apply </button> </div></div><div class="courses-container"> <div class="course"> <div class="course-preview"> <h4>Visa Credit Card </h4> </div> <div class="course-info"> <h6>Lowest intro APR for 21 months </h6> <h6>0% intro APR for 18 months </h6> <h6>$0 annual fee </h6> </div> <button id="reflectCard" class="cutomBtn">Apply </button> </div></div><div class="courses-container"> <div class="course"> <div class="course-preview"> <h4>Master Credit Card </h4> </div> <div class="course-info"> <h6>60,000 bonus points </h6> <h6>5X-3X points on various categories </h6> <h6>Up to 7 reward nights </h6> <h6>$0 annual fee </h6> </div> <button id="masterCard" class="cutomBtn">Apply </button> </div></div><div class="courses-container"> <div class="course"> <div class="course-preview"> <h4>Select Master Credit Card </h4> </div> <div class="course-info"> <h6>90,000 bonus points </h6> <h6>10X-5X points on various categories </h6> <h6>Up to 11 reward nights </h6> <h6>$95 annual fee (waived first year) </h6> </div> <button id="selectMasterCard" class="cutomBtn">Apply </button> </div></div>';
